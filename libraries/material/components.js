...
prx.types.material_tabbar_segmented_button = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		$.each(item.tabs, function(i,elm){			
			...
			cR += '<li class="material-tabbar-button-list-item ' + (cChecked == '' ? 'liveUpdate-backgroundColor' : '') + ' changeProperty-backgroundColor changeProperty-backgroundColorActive dynamic-property '+((prx.componentsHelper.getProp(item.rippleEffect,'boolean')) ? 'prx-material-ripple' : '' )+'" data-dynamic-property-index="'+i+'" id="'+_id+'-tabs-'+i+'" '+((prx.componentsHelper.getProp(elm.linkedscreen,'num-other') != -1) ? 'data-linked-screen="'+prx.componentsHelper.getProp(elm.linkedscreen,'num-other')+'"' : '')+'>';
			...
			cR += '<label class="material-tabbar-button-list-item-icon-wrapper ' + (cChecked != '' ? 'liveUpdate-backgroundColorActive' : '') + '" for="'+_id+'-radio-'+i+'"><span class="material-tabbar-button-list-item-icon liveUpdate-iconActiveMask"></span></label>';
			cR += '</li>'; 			
		});
...
prx.types.material_onoffswitch = {
	...
	,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<span class="material-onoff-inner-before liveUpdate-activeLabelColor changeProperty-activeLabelColor"></span>';
        cR += '<span class="material-onoff-inner-after liveUpdate-inactiveLabelColor changeProperty-inactiveLabelColor"></span>';
        cR += '</span>';
...
prx.types.material_progress_determinate = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="material-progress-bg-bar liveUpdate-backgroundColor changeProperty-backgroundColor">';
		
		if( prx.componentsHelper.getProp(item.isDownloading,'boolean') )
		cR += '<div class="material-progress-downloading-bar liveUpdate-percentBarBackgroundColor changeProperty-percentBarBackgroundColor changeProperty-percentBarValue changeProperty-percentWidth"></div>';
		else
